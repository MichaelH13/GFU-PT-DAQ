Public Class frmViewOutputVariables
    ...
    Private Sub btnSaveVariables_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveVariables.Click
        ...
        variablesToWriteToFile.Add("Left Leg Area Seat Off to End of Test: " & Me.txtLeftLegAreaSeatOffToEndOfSTS.Text)
        ...
        variablesToWriteToFile.Add("Right Leg Area Seat Off to End of Test: " & Me.txtRightLegAreaSeatOffToEndOfSTS.Text)
        ...
        If (frmSaveTest.ShowDialog() = System.Windows.Forms.DialogResult.OK) Then
            IO.File.WriteAllLines(frmSaveTest.FileName, variablesToWriteToFile)
