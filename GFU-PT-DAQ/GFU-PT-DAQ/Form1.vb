Public Class Form1
    ...
    Private Sub Timer2_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer2.Tick
        ...
        er = myDAQ.AIn(3, MccDaq.Range.Bip10Volts, dataValueC3)

        'If (er.Value <> 0) Then MsgBox(er.Message)

        'MsgBox(dataValueC3)
        er = myDAQ.ToEngUnits(MccDaq.Range.Bip10Volts, dataValueC3, engUnitC3)
        'MsgBox(engUnitC3)
        'If (er.Value <> 0) Then MsgBox(er.Message)
        list3.Add(engUnitC3)
        lbl3.Text = engUnitC3
